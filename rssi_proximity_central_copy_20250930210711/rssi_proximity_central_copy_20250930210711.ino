...
#define ARRAY_SIZE     (20)    // The number of RSSI values to store and compare
#define TIMEOUT_MS     (1000) // Number of milliseconds before a record is invalidated in the list
...
void setup()
{
  ...
  Bluefruit.Scanner.filterMSD(0x0505);          // Only invoke callback when MSD is present with the specified Company ID
